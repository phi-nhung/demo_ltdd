    ...
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: [
          ...
          _buildDashboardItem(context, QuanLyKhachHang(),Icons.person_pin_outlined, "Khách hàng"),
          _buildDashboardItem(context,QuanLyNhanVien(), Icons.people, "Nhân viên"),
          _buildDashboardItem(context, DoangThu(),Icons.bar_chart_outlined, "Doanh thu"),
